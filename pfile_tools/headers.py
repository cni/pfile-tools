...
def REVISIONS():
    return {
        ...
        '27'    : R27_000PfileHeader,
        '27.001': R27_001PfileHeader,
        '28.002': R28_002PfileHeader,
        '30'    : R30_000PfileHeader,
    }
...
class R20_007PfileHeader(LittleEndianStructure):
    ...
    _fields_ = [
        ...
        ('pad_10', c_char * 138658),
        ('mps_r1', c_int),		# rdb_hdr_ps_mps_r1
        ('mps_r2', c_int),
        ('mps_tg', c_int),
        ('mps_frequency', c_uint),
        ('aps_r1', c_int),
        ('aps_r2', c_int),
        ('aps_tg', c_int),
        ('aps_frequency', c_uint),
...
class R26_002PfileHeader(LittleEndianStructure):
    ...
    _fields_ = [
        ...
        ('pad_9p', c_char * 36),
        ('num_difdirs', c_short),       # number of diffusion directions
        ('pad_10', c_char * 188874),    # (139618 + 50764 - 16)
        ('mps_r1', c_int),		# rdb_hdr_ps_mps_r1
        ('mps_r2', c_int),
        ('mps_tg', c_int),
        ('mps_frequency', c_uint),
...
class R27_000PfileHeader(LittleEndianStructure): # RX27.0 R01, UHP
...
class R28_002PfileHeader(LittleEndianStructure):
    ...
    _fields_ = [
        ...
        ('z_shim', c_short),
        ('recon_enabled', c_short),
        ('pad_11p2', c_char * 2696),
        ('mps_frequency', c_ulonglong), # rdb_hdr_ps_mps_freq, unsigned long long
        ('aps_frequency', c_ulonglong),
        ('pad_12', c_char * 720),      
        ('magnet_strength', c_int),
        ('patient_weight_g', c_int),
        ('exam_timestamp', c_int),
...
class R30_000PfileHeader(LittleEndianStructure):
